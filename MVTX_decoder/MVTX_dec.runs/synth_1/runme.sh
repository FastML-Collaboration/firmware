...
HD_PWD='D:/sphenix/MVTX_dec/MVTX_decoder/MVTX_dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_state_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_state_machine.tcl
