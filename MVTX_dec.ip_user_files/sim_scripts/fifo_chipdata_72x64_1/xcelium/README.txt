...
#
# Generated by export_simulation on Wed Nov 22 19:59:19 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_chipdata_72x64.sh' script.

./fifo_chipdata_72x64.sh -reset_run
...
./fifo_chipdata_72x64.sh -noclean_files

For more information on the script, please type './fifo_chipdata_72x64.sh -help'.
